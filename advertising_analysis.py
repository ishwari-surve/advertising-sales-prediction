...
def analyze_advertising_sales(DataPath):
    Border = "-"*40
    #------------------------------------
    #Step 1 : Load dataset
    #------------------------------------
    ...
    #------------------------------------
    print(Border)
    print("Step 6: Split data into independent and dependent variables   ")
    print(Border)
    ...
    #------------------------------------
    #Step 8:Create and train the mode
    #------------------------------------
    print(Border)
...
def main():
     analyze_advertising_sales(DataPath):("Advertising.csv")
